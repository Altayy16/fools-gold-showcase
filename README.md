...
> **Note:** The full source code for *Fools Gold* is currently private as the game is preparing for official release on mobile app stores. This repository serves as a technical showcase outlining the system architecture, visual design, DevOps infrastructure, and engineering principles used to build the game.
...
* **Monetization & Engagement:** RevenueCat (In-App Purchases) & Push Notifications
* **DevOps & Infrastructure:** Self-hosted Hetzner VPS, Docker, Docker Compose, Nginx
...
Implemented **RevenueCat** to handle secure, cross-platform subscription and in-app purchase validation. Integrated **Push Notifications** to drive player retention and alert users of matchmaking events.

### 5. Disciplined Code Architecture
...
* Overrode standard UI abbreviations (e.g., K/M/B) to display exact, full currency counts (`BIGINT`), ensuring precise balance visibility for a better player experience.
